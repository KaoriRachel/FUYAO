...
# For QPS = 400
#$WRK_BIN -d10s -c200 -t40 -R3000 --u_latency -s $WRK_SCRIPT $URL

#$WRK_BIN -d10s -c200 -t40 -R3000 --u_latency -s $WRK_SCRIPT $URL

$WRK_BIN -d60s -c200 -t40 -R100 --u_latency -s $WRK_SCRIPT $URL

#$WRK_BIN -d60s -c200 -t40 -R1 --u_latency -s $WRK_SCRIPT $URL
