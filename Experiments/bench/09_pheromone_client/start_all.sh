...
host_config_path="/home/lgw/Lumine-benchmarks/Experiments/bench/09_pheromone_client/service_config.json"
...
ssh -p 22 lgw@192.168.1.126 "${rm_dir}; cmake --build /tmp/host6 --target gateway engine launcher exp09_start_for_finra exp09_start_for_chain -- -j 16"
#ssh -p 22 lgw@192.168.1.192 "${rm_dir}; cmake --build /tmp/host9 --target gateway engine launcher exp09_start_for_chain exp09_start_for_finra-- -j 16"
